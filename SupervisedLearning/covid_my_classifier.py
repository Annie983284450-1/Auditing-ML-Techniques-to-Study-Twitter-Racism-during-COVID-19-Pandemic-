...
if __name__ == '__main__':
    ...
    #     pickle.dump(((X_train, y_train), (X_validation, y_validation), (X_test, y_test)), f)
    ...
    print("DC Train acc", clf.score(X_train, y_train))
    print("DC Validation acc", clf.score(X_validation, y_validation))
    print("DC Test acc", clf.score(X_test, y_test))

    from sklearn.ensemble import RandomForestClassifier
    clf = RandomForestClassifier(n_estimators=100)
    clf = clf.fit(X_train, y_train)
    print("RF Train acc", clf.score(X_train, y_train))
    print("RF Validation acc", clf.score(X_validation, y_validation))
    print("RF Test acc", clf.score(X_test, y_test))

    from sklearn.naive_bayes import GaussianNB
    clf = GaussianNB(priors=[0.55,0.2,0.2,0.05])
    clf = clf.fit(X_train, y_train)
    print("MNB Train acc", clf.score(X_train, y_train))
    print("MNB Validation acc", clf.score(X_validation, y_validation))
    print("MNB Test acc", clf.score(X_test, y_test))

    from sklearn.neighbors import KNeighborsClassifier
    clf = KNeighborsClassifier(n_neighbors=17,weights="distance")
    clf = clf.fit(X_train, y_train)
    print("kNN Train acc", clf.score(X_train, y_train))
    print("kNN Validation acc", clf.score(X_validation, y_validation))
    print("kNN Test acc", clf.score(X_test, y_test))

    from sklearn.ensemble import AdaBoostClassifier
    clf = AdaBoostClassifier(n_estimators=1000)
    clf = clf.fit(X_train, y_train)
    print("Ada Train acc", clf.score(X_train, y_train))
    print("Ada Validation acc", clf.score(X_validation, y_validation))
    print("Ada Test acc", clf.score(X_test, y_test))

    from sklearn.ensemble import GradientBoostingClassifier
    clf = GradientBoostingClassifier(n_estimators=1000, learning_rate=1.0, max_depth=1, random_state=0)
    clf = clf.fit(X_train, y_train)
    print("GB Train acc", clf.score(X_train, y_train))
    print("GB Validation acc", clf.score(X_validation, y_validation))
    print("GB Test acc", clf.score(X_test, y_test))
